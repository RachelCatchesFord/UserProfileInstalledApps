...
$wmiCustomClass = "UserInstalledApps" # Will be created in the $wmiCustomNamespace. Will also be used to name the view in Configuration Manager
...
Foreach ($item in $profilesToQuery) {
    ...
    if ($userApps) {
        ...
        $userApps | ForEach-Object {
            ...
            # Write-Host -Value "-> Adding $DisplayName"
